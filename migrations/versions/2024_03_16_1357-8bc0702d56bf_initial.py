...
def upgrade() -> None:
    ...
    sa.Enum('STAFF', 'MANAGER', name='assigneeENUM').create(op.get_bind())
    sa.Enum('OPEN', 'PROCESSING', 'CLOSED', name='statusENUM').create(op.get_bind())
    sa.Enum('USER', 'STAFF', 'MANAGER', 'ADMIN', name='roleENUM').create(op.get_bind())
    op.create_table('user',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=30), nullable=False),
    sa.Column('email', sa.String(length=320), nullable=False),
    sa.Column('role', postgresql.ENUM('USER', 'STAFF', 'MANAGER', 'ADMIN', name='roleENUM', create_type=False), nullable=False),
    ...
    sa.Column('assignee', postgresql.ENUM('STAFF', 'MANAGER', name='assigneeENUM', create_type=False), nullable=False),
